...
export const toast = {
  message: (msg: string) => void loadSonner().then(m => m.toast.message(msg)),
  success: (msg: string) => void loadSonner().then(m => m.toast.success(msg)),
  error: (msg: string) => void loadSonner().then(m => m.toast.error(msg)),
  warning: (msg: string) => void loadSonner().then(m => m.toast.warning(msg)),
};
