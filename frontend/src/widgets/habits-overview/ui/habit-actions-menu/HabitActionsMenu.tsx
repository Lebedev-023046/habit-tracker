...
import { habitRunActionFactory } from '../../model/actions/action-factory';
import { HABIT_ACTIONS_BY_STATUS } from '../../model/actions/action-rules';
import type { HabitListItem } from '../../model/habitList.service';
    ...
    <>
      ...
      >
        <div className={styles.btns}>
          {actions.map(action => {
            const Action = habitRunActionFactory[action];
