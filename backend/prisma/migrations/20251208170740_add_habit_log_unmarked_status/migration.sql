/*
  ...
  - The values [done] on the enum `HabitDayStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "HabitDayStatus_new" AS ENUM ('сompleted', 'missed', 'unmarked');
